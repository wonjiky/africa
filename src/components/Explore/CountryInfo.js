...
const methods = {
    ...
    data: [
            ...
            },
            {
              ...
              "Surface": 1930,
              "Density": 1172,
              "Country_name": "République du Soudan du Sud"
            },
            {
              "Country": "UGA",
              "Name": "Mbale [UGA]",
...
class CountryInfo extends Component {
    ...
    renderInfo(list){
        return(
			<ul key={list.id} className="list-unstyled ">
				<li>
					<h3>{list.name}</h3>
					<br/>
				</li>
        ...
        if(this.props.selectedCountry){
			...
			return(
				<Row className="treemap-row">
					<Col md={5} mdOffset={2} className="treemap-style">
						<div id="viz">
							<Treemap config={methods}/>
						</div>                       
					</Col>
					<Col md={3}  className="treemap-text">
