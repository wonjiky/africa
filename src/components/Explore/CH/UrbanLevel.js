...
class UrbanLevel extends Component {
    constructor(props){
        super(props);
        this.state={
            fillColor:''
    ...
    uPop(chart, width, height, selectedValue, countries) {
        ...
        const yScale = d3.scaleLinear()
            .domain([0, d3.max(countries, d => d.Ulvl_Scaled)])
            .range([height, 0]);
        ...
        chart.selectAll('.bar')
            ...
            .attr('y', d => yScale(d.Ulvl_Scaled))
            .attr('height', d => (height - yScale(d.Ulvl_Scaled)))
    ...
    uPopyScale(countries){
        countries.sort(function (a, b) {
            return d3.ascending(a.Ulvl_Scaled, b.Ulvl_Scaled);
        })
    }
